...
const Sidebar = () => {
    return (
        <div className="flex-[0_0_370px] d-flex flex-col gap-[10px] mx-[5px] justify-end">
            <div className="text-white bg-[#1634cf] p-[7px] rounded-3xl justify-center items-center">
                <span className="text-3xl">Труфаций</span>
            </div>

            <div className="d-flex flex-col rounded-lg bg-[#76788b] border border-solid border-[#222084]">
